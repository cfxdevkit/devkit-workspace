...
function ConfluxLogo() {
  return (
    <svg viewBox="0 0 1766.6 2212" aria-hidden="true" className="w-5 h-auto block fill-accent shrink-0 transition-transform duration-500 group-hover:scale-110">
        ...
        <div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-3 px-5 py-2.5">
          <div className="flex items-center gap-3 cursor-default group">
            ...
            <div className="flex flex-col select-none">
              <span className="font-black text-[1.05rem] text-white leading-none tracking-tight uppercase">CFX DevKit</span>
              <span className="mt-1 text-[8px] font-black uppercase tracking-[0.18em] leading-none text-text-secondary/40 transition-colors group-hover:text-accent/60">Project Sandbox</span>
            </div>
          </div>

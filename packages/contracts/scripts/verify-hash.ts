...
const CANONICAL_HASH = '0x96e8ac4277198ff8b6f785478aa9a39f403cb768dd02cbee326c3e7da348845f';
...
if (computedHash === CANONICAL_HASH) {
  ...
  console.log(`    Replace the hex value in UniswapV2Library.sol with: ${computedHash}`);

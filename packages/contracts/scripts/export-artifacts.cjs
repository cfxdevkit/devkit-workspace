...
const CONTRACTS = {
	...
	UniswapV2Factory:
		"@uniswap/v2-core/contracts/UniswapV2Factory.sol/UniswapV2Factory.json",
	UniswapV2Pair:
		"@uniswap/v2-core/contracts/UniswapV2Pair.sol/UniswapV2Pair.json",
	UniswapV2ERC20:
		"@uniswap/v2-core/contracts/UniswapV2ERC20.sol/UniswapV2ERC20.json",
	// V2 Periphery (compiled from @uniswap/v2-periphery/contracts/)
	UniswapV2Router02:
		"@uniswap/v2-periphery/contracts/UniswapV2Router02.sol/UniswapV2Router02.json",
...
for (const [name, relPath] of Object.entries(CONTRACTS)) {
	...
	console.log(
		`✓  ${name} → artifacts/${name}.json  (bytecode: ${hh.bytecode.length / 2 - 1} bytes)`,
	);
}
...
fs.writeFileSync(
	path.join(OUT_DIR, "_hash-info.json"),

...
const FLOW_MAP: Array<{
	...
	// ── Lifecycle ───────────────────────────────────────────────────────────────
	{
		mcpTool: "conflux_server_start",
		extensionCommand: "cfxdevkit.serverStart",
	},
	{
		mcpTool: "conflux_status",
		extensionCommand: null,
		note: "handled by status-bar poller",
	},
	{
		mcpTool: "conflux_node_status",
		extensionCommand: null,
		note: "embedded in tree-view refresh",
	},
	...
	{
		mcpTool: "conflux_node_restart",
		extensionCommand: "cfxdevkit.nodeRestart",
	},
	{
		mcpTool: "conflux_node_wipe_restart",
		extensionCommand: "cfxdevkit.nodeWipeRestart",
	},
	{ mcpTool: "conflux_node_wipe", extensionCommand: "cfxdevkit.nodeWipe" },

	// ── Keystore ────────────────────────────────────────────────────────────────
	{
		mcpTool: "conflux_setup_init",
		extensionCommand: "cfxdevkit.initializeSetup",
	},
	{
		mcpTool: "conflux_keystore_status",
		extensionCommand: null,
		note: "embedded in status-bar poller",
	},
	{
		mcpTool: "conflux_keystore_unlock",
		extensionCommand: "cfxdevkit.unlockKeystore",
	},
	{ mcpTool: "conflux_wallets", extensionCommand: "cfxdevkit.viewAccounts" },

	// ── Network ─────────────────────────────────────────────────────────────────
	{
		mcpTool: "conflux_rpc_urls",
		extensionCommand: null,
		note: "surfaced via web UI / tree view",
	},
	{ mcpTool: "conflux_accounts", extensionCommand: "cfxdevkit.viewAccounts" },
	{
		mcpTool: "conflux_fund_account",
		extensionCommand: null,
		note: "surfaced via web UI faucet panel",
	},
	{ mcpTool: "conflux_mine", extensionCommand: "cfxdevkit.mineBlocks" },
	{
		mcpTool: "conflux_mining_start",
		extensionCommand: null,
		note: "handled by auto-mining toggle in web UI",
	},
	{
		mcpTool: "conflux_mining_stop",
		extensionCommand: null,
		note: "handled by auto-mining toggle in web UI",
	},
	...
	// ── Contracts ───────────────────────────────────────────────────────────────
	{
		mcpTool: "conflux_templates",
		extensionCommand: null,
		note: "embedded in cfxdevkit.deployContract flow",
	},
	...
	{
		mcpTool: "conflux_bootstrap_catalog",
		extensionCommand: null,
		note: "embedded in cfxdevkit.deployDex flow",
	},
	{
		mcpTool: "conflux_bootstrap_deploy",
		extensionCommand: "cfxdevkit.deployDex",
	},
];
...
describe("MCP ↔ extension flow parity", () => {
	...
	it.each(
		FLOW_MAP.filter((r) => r.extensionCommand !== null),

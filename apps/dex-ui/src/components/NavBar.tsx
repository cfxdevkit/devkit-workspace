import { ConnectButton } from "@devkit/ui-shared";
...
function ConfluxIcon() {
	return (
		<svg
			...
			className="w-5 h-auto fill-accent transition-transform duration-500 group-hover:scale-110"
		>
			<title>Conflux</title>
			...
			<div className="mx-auto flex w-full max-w-7xl items-center justify-between gap-3 px-5 py-2.5">
				<div className="flex items-center gap-3 cursor-default group">
					...
					<div className="flex flex-col gap-0.5">
						<span className="font-black text-[1.05rem] text-white leading-tight tracking-tight uppercase">
							CFX <span className="text-accent">DEX</span>
						</span>
						<div className="flex items-center gap-1.5 text-[8px] font-black uppercase tracking-[0.14em] text-text-secondary/40">
							...
							<span className="group-hover:text-accent/60 transition-colors">
								Playground
							</span>
						</div>
					</div>
